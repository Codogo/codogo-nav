...
var linkStyle = [(0, _styledComponents.css)(["display:block;padding:", ";border-bottom:1px solid ", ";color:", ";input[type=\"checkbox\"]:checked + div{opacity:0;max-height:0;border:none;}"], function (props) {
...
})(["font-size:0.8em;position:absolute;right:1em;", ";"], _codogoUtilityFunctions.bp.sm.min(_templateObject2));
	...
	return _react2.default.createElement(
		...
		props.children.map(function (navlink, i) {
			return navlink.notLink === true ? _react2.default.createElement(
				...
				LinkWrapper,
				(0, _extends3.default)({ key: "navlink" + i }, props),
				navlink,
				...
				navlink.props.dropdown && _react2.default.createElement(DropdownInput, { type: "checkbox", name: "one", id: "item-" + i, htmlChecked: true }),
				navlink.props.dropdown && _react2.default.createElement(_DropdownLinks2.default, { dropdown: navlink.props.dropdown })
			);
		})
	);
};
