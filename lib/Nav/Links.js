...
}), (0, _styledComponents.css)(["padding:0 ", ";letter-spacing:0.1em;color:", ";height:100%;display:flex;justify-content:center;align-items:center;&:hover{text-decoration:", ";border-bottom:", ";padding-top:", ";}"], function (props) {
...
})(["", ";", ";font-family:", ";a{", ";", ";}> .active{font-weight:bold;border-bottom:", ";padding-top:", ";}", ";", ";"], function (props) {
...
var Links = function Links(props) {
	return _react2.default.createElement(
		...
		(console.log(props), props.children.map(function (navlink, i) {
